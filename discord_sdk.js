const DISCORD_APP_ID = "1351052958112026665";
const DISCORD_LOGIN_URL = `https://${DISCORD_APP_ID}.discordsays.com/.proxy/usa-1/api/accounts/login/discord`;
const DISCORD_SERVER_INVITE_LINK = "https://discord.gg/GNQQkqCDkx";
  ...
  script.onload = function () {
    if (window.DiscordSDK?.patchUrlMappings instanceof Function) {
      window.DiscordSDK.patchUrlMappings([
        { prefix: '/files', target: 'files.veck.io' },
        { prefix: '/fra-1', target: 'fra-1.veck.io' },
        { prefix: '/fra-2', target: 'fra-2.veck.io' },
        { prefix: '/fra-3', target: 'fra-3.veck.io' },
        { prefix: '/fra-4', target: 'fra-4.veck.io' },
        { prefix: '/fra-5', target: 'fra-5.veck.io' },
        { prefix: '/asia-1', target: 'asia-1.veck.io' },
        { prefix: '/asia-2', target: 'asia-2.veck.io' },
        { prefix: '/asia-3', target: 'asia-3.veck.io' },
        { prefix: '/asia-4', target: 'asia-4.veck.io' },
        { prefix: '/asia-5', target: 'asia-5.veck.io' },
        { prefix: '/usa-1', target: 'usa-1.veck.io' },
        { prefix: '/usa-2', target: 'usa-2.veck.io' },
        { prefix: '/usa-3', target: 'usa-3.veck.io' },
        { prefix: '/usa-4', target: 'usa-4.veck.io' },
        { prefix: '/usa-5', target: 'usa-5.veck.io' },
        { prefix: '/dev-usa-1', target: 'dev-usa-1.veck.io' },
        { prefix: '/veck', target: 'veck.io' },
